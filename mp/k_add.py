...
def add_activity(request):
    ...
    cursor.execute("insert into activities values(null,%s,%s,%s,%s,0,%s,%s,%s,'0','0','asd',0,'0',sysdate())",(request.POST['atitle1'],request.POST['atitle2'],request.POST['aprice'],request.POST['aprice_old'],request.POST['adate'],request.POST['ahour'],request.POST['adetail'],))
    cursor.close()
