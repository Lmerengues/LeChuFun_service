...
def add_activity(request):
    ...
    cursor.execute("insert into activities values(null,%s,%s,%s,%s,0,'2018-06-05','1','1','1','1','1',0,'0',sysdate())",(request.POST['atitle1'],request.POST['atitle2'],request.POST['aprice'],request.POST['aprice_old'],))
    cursor.close()
